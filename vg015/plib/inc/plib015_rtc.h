...
/**
  * @brief   Чтение значения таймера RTC
  * @retval  Значение таймера
  */
...
/**
  * @brief   Запись значения таймера RTC
  * @param   Time  Значение таймера
  * @retval  void
  */
__STATIC_INLINE void RTC_SetCounter(uint32_t Time)
{
    WRITE_REG(PMURTC->RTC_TIME, Time);
}
