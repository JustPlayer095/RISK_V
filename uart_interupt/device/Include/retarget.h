...
#define RETARGET_UART_PIN_TX_POS 3
#define RETARGET_UART_PIN_RX_POS 2
#define RETARGET_UART_RX_IRQHandler UART1_IRQHandler
#define RETARGET_UART_RX_IRQn UART1_IRQn
