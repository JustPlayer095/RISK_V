...
#define RETARGET_UART UART4
#define RETARGET_UART_NUM 4
#define RETARGET_UART_PORT GPIOA
#define RETARGET_UART_PIN_TX_POS 9
#define RETARGET_UART_PIN_RX_POS 8
#define RETARGET_UART_RX_IRQHandler UART4_IRQHandler
#define RETARGET_UART_RX_IRQn UART4_IRQn
