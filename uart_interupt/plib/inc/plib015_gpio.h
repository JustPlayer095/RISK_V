...
#ifndef __PLIB015_GPIO_H
#define __PLIB015_GPIO_H
...
/**
  * @brief  Выбор альтернативной функции
  */
typedef enum {
    GPIO_AltFuncNum_None = GPIO_ALTFUNCNUM_PIN0_Disable, /*!< Альтернативная функция не выбрана */
    GPIO_AltFuncNum_1 = GPIO_ALTFUNCNUM_PIN0_AF1,        /*!< Альтернативная функция 1 */
    GPIO_AltFuncNum_2 = GPIO_ALTFUNCNUM_PIN0_AF2,        /*!< Альтернативная функция 2 */
    GPIO_AltFuncNum_3 = GPIO_ALTFUNCNUM_PIN0_AF3,        /*!< Альтернативная функция 3 */
} GPIO_AltFuncNum_TypeDef;
#define IS_GPIO_ALT_FUNC_NUM(VALUE) (((VALUE) == GPIO_AltFuncNum_None) || \
                                     ((VALUE) == GPIO_AltFuncNum_1) ||    \
                                     ((VALUE) == GPIO_AltFuncNum_2) ||    \
                                     ((VALUE) == GPIO_AltFuncNum_3))

#define IS_GPIO_QUAL_PERIOD(VALUE) (((VALUE)&0xFFF00000) == 0)
...
typedef struct
{
    ...
    GPIO_AltFuncNum_TypeDef AltFuncNum; /*!< Определяет номер периферийной функции пинов */
...
void GPIO_AltFuncNumConfig(GPIO_TypeDef* GPIOx, uint32_t Pin, GPIO_AltFuncNum_TypeDef AltFunc);
