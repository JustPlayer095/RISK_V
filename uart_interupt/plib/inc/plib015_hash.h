...
/**
  * @brief   Получение занятости хеш-процессора
...
/**
  * @brief   Готовность входного буфера принять новый блок
  * @retval  state Бит готовности входного буфера
  */
__STATIC_INLINE FunctionalState HASH_DINStatus()
{
	return (FunctionalState) (READ_BIT(HASH->SR, HASH_SR_DINIS_Msk));
}
