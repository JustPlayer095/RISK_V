...
#ifndef __PLIB015_RTC_H
#define __PLIB015_RTC_H
...
/**
  ...
  * @retval  void
  */
__STATIC_INLINE void RTC_SetCounter(uint32_t CounterVal)
{
    WRITE_REG(PMURTC->RTC_TIME, CounterVal);
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t RTC_GetCounter()
{
    return READ_REG(PMURTC->RTC_TIME);
}

/**
  * @brief   Установка значения Alarm
  * @param   AlarmVal  Значение Alarm
  * @retval  void
  */
__STATIC_INLINE void RTC_SetAlarm(uint32_t AlarmVal)
{
    WRITE_REG(PMURTC->RTC_ALARM, AlarmVal);
}

/**
  * @brief   Получение текущего значения Alarm.
  * @retval  Val  Значение Alarm
  */
__STATIC_INLINE uint32_t RTC_GetAlarm()
{
    return READ_REG(PMURTC->RTC_ALARM);
}

/**
  * @brief   Разрешение работы от внешнего осциллятора
  * @param   State  Выбор состояния
  * @retval  void
  */
__STATIC_INLINE void RTC_ExtOscCmd(FunctionalState State)
{
    assert_param(IS_FUNCTIONAL_STATE(State));

    WRITE_REG(PMURTC->RTC_CFG0_bit.EXTOSC, State);
}

void RTC_GetTime(RTC_Time_TypeDef* RTC_Time);
void RTC_GetDate(RTC_Date_TypeDef* RTC_Date);
void RTC_SetTime(RTC_Time_TypeDef* RTC_Time);
void RTC_SetDate(RTC_Date_TypeDef* RTC_Date);
