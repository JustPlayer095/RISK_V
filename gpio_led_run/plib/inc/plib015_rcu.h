...
//#define RCU_AHBClk_CRC0     RCU_CGCFGAHB_CRC0AEN_Msk   /*!< Управление тактированием блока CRC0 */
//#define RCU_AHBClk_CRC1     RCU_CGCFGAHB_CRC1AEN_Msk   /*!< Управление тактированием блока CRC1 */
...
/**
  * @brief   Разрешение работы PLLSYS
  * @param   State  Выбор состояния
  * @retval  void
  */
...
/**
  * @brief   Включение режима bypass PLLSYS
  * @param   State  Выбор состояния
  * @retval  void
  */
__STATIC_INLINE void RCU_PLLSYS_BypassCmd(FunctionalState State)
{
    assert_param(IS_FUNCTIONAL_STATE(State));
...
/**
  * @brief   Получение статуса захвата частоты PLLSYS
  * @retval  Status  Статус захвата
  */
__STATIC_INLINE FlagStatus RCU_PLLSYS_LockStatus(void)
{
...
/**
  ...
  * @retval  void
  */
__STATIC_INLINE void RCU_IWDTClkConfig(RCU_IWDTClk_TypeDef IWDTClk, uint32_t DivVal, FunctionalState DivState)
{
...
/**
  * @brief   Включение тактирования независимого сторожевого таймера
  * @param   State  Выбор состояния
  * @retval  void
  */
__STATIC_INLINE void RCU_IWDTClkCmd(FunctionalState State)
{
    assert_param(IS_FUNCTIONAL_STATE(State));

//    WRITE_REG(PMURTC->IWDG_CFG_bit.CLKEN, State);
}
